  ...
  const drinks = [
    {
      ...
      price: 299,
      oldPrice: 399,
      description: "Зеленый энергетик с вкусом лайма",
      image: "/img/fa4f57b6-d5de-4724-a783-d8057e1a264d.jpg",
    },
    {
      id: 2,
      name: "CYBER COLA",
      price: 199,
      oldPrice: 249,
      description: "Кола с кибер-вкусом",
      image: "/img/fa4f57b6-d5de-4724-a783-d8057e1a264d.jpg",
    },
    {
      id: 3,
      ...
      price: 349,
      oldPrice: 449,
      description: "Светящийся сок с витаминами",
      image: "/img/fa4f57b6-d5de-4724-a783-d8057e1a264d.jpg",
    },
    {
      id: 4,
      ...
      price: 149,
      oldPrice: 199,
      description: "Черный чай для хакеров",
      image: "/img/fa4f57b6-d5de-4724-a783-d8057e1a264d.jpg",
    },
    {
      id: 5,
      ...
      price: 249,
      oldPrice: 299,
      description: "Кофе для программистов",
      image: "/img/fa4f57b6-d5de-4724-a783-d8057e1a264d.jpg",
    },
    {
      id: 6,
      ...
      price: 99,
      oldPrice: 149,
      description: "Вода для взлома систем",
      image: "/img/fa4f57b6-d5de-4724-a783-d8057e1a264d.jpg",
    },
  ];
      ...
      <header className="border-b border-green-400/20 bg-black/90 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <Icon
              name="Terminal"
              className="text-green-400 text-glow"
              size={32}
            />
      ...
      <section className="py-20 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex justify-center space-x-4 mb-8">
            <Badge
              variant="outline"
              className="border-green-400 text-green-400 px-4 py-2"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {drinks.map((drink) => (
              <Card
                key={drink.id}
                className="bg-black/50 border-green-400/30 hover:border-green-400 transition-all duration-300 hover-glow"
              >
                <CardHeader className="pb-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-green-400 text-glow text-lg">
                        {drink.name}
                      </CardTitle>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex justify-end">
          <div className="w-full max-w-md bg-black border-l border-green-400/30 p-6 overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-green-400 text-glow">
                КОРЗИНА
              </h3>
            ...
            {cart.length === 0 ? (
              <p className="text-green-300/70 text-center py-8">
                Корзина пуста
              </p>
            ) : (
              <>
                <div className="space-y-4 mb-6">
                  {cart.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-center justify-between p-4 border border-green-400/20 rounded"
                    >
                      <div>
                ...
                <div className="border-t border-green-400/20 pt-4">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-2xl font-bold text-green-400 text-glow">
                      {getTotalPrice()}₽
                    </span>
                  </div>
      ...
      <footer className="border-t border-green-400/20 py-8">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-green-400 font-bold text-glow">
              DARKNET MARKET
            </span>
          </div>
          <p className="text-green-300/70 text-sm">
